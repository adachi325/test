...
<a href="mailto:?subject=<?php echo $mailSubject; ?>&body=<?php echo urlencode(mb_convert_encoding($mailBody,"utf8")); ?>"><span style="color:#339900;">印刷用URLを送る</span></a><br>
<a href="mailto:?subject=<?php echo $mailSubject; ?>&body=<?php echo rowurlencode(mb_convert_encoding($mailBody,"utf8")); ?>"><span style="color:#339900;">印刷用URLを送る</span></a><br>
