...
<object declare id="preview" data="<?php echo sprintf(Configure::read('Present.screen_output'), $selected['child_id'], $selected['child_id']); ?>" type="application/x-shockwave-flash" width="200" height="250">
