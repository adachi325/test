...
<?php echo $this->Form->create('Child', array('url' => '/children/edit_complete?guid=ON', "inputDefaults" => array("dev" => false, "label" => false))); ?>
...
<?php echo $this->Form->create('Child', array('url' => '/children/edit?guid=ON', "inputDefaults" => array("dev" => false, "label" => false))); ?>
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center">
