...
<?php echo $this->Form->input("nickname", array("type" => "text", 'error' => false, "style" => "font-size:x-small;")); ?><br />
...
<div><font color="#ff0000"><?php echo $form->error('sex','必須項目です'); ?></font></div>
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "5")); ?>
</div></td>
</tr>
...
<?php echo $this->Form->input('line_id', array('style' => 'font-size:x-small;','error' => false)); ?><br />
<font color="#ff0000"><?php echo $form->error('line_id', null, array('wrap' => false)); ?></font><br />
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "5")); ?>
</div></td>
</tr>
