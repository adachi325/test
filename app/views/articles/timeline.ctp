...
<a href="<?php echo $this->Html->url('/articles/views/page:' . $page . '?guid=ON&' . session_name() . '=' . session_id()); ?>" style="color:#ff9900"><span style="font-size:x-small; color:#ff9900;">前のページ</span></a>
<?php else : ?>
前のページ
<?php endif; ?>
</td>
...
<?php $page = $paginator->current() + 1; ?>
<a href="<?php echo $this->Html->url('/articles/views/page:' . $page . '?guid=ON&' . session_name() . '=' . session_id()); ?>" style="color:#339900">もっと見る</a>
<?php else : ?>
もっと見る
<?php endif; ?>
</td>
