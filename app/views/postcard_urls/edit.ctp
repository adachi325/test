...
<?php echo $form->create('PostcardUrl');?>
	<fieldset>
 		<legend><?php __('Edit PostcardUrl');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('PostcardUrl.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('PostcardUrl.id'))); ?></li>
