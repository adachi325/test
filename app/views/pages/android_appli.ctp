...
<div id="top_promo">
  ...
  <div class="headintrobtn">
    <div class="green_btn"><a href="market://details?id=jp.dctry.shimajiro" ><?php echo $this->Html->image("sp_img/bt_green_download2.png", array("alt" => "ダウンロード")); ?></a></div>
  </div>
...
<div class="introbtn">
 <div class="green_btn"><?php echo $this->Html->image("sp_img/appliwo.png", array("alt" => "しまじろうひろば×ドコモコミュニティアプリを", "width" => "100%")); ?><a href="market://details?id=jp.dctry.shimajiro" ><?php echo $this->Html->image("sp_img/bt_green_download2.png", array("alt" => "ダウンロード")); ?></a></div>
</div>
</div>
<!-- /#main -->
