...
<span style="color:#996633;">・</span><a href="http://docomo-community.com/djs/inquiry_top.xhtml" style="color:#cc6600;"><span style="color:#cc6600;">ｿﾌﾄﾊﾞﾝｸをお使いの方</span></a><br />
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "10")); ?><br />
