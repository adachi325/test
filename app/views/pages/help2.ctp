...
<div align="center" style="text-align:center"><?php echo $this->Html->image("line_obj04.gif", array("alt" => "")); ?></div>
	   
<span style="color:#996633;">&nbsp;･ｻｰﾋﾞｽ全般</span><br />
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "7", "alt" => "")); ?><br />
...
②ｽﾏｰﾄﾌｫﾝ(Android2.1以上):ご利用いただけます｡(ただし､一部機種を除く)｡</span></td>
</tr>
</table>
<div style="background:#fff0dd;">
<table width="100%" cellpadding="0" cellspacing="0">
...
<td><span style="font-size:x-small;color:#333333">①ﾌｨｰﾁｬｰﾌｫﾝに変更する場合:ご利用いただけます｡｢http://dctry.jp/shimajiro/(しまじろうひろば×ﾄﾞｺﾓｺﾐｭﾆﾃｨTOP)｣からﾛｸﾞｲﾝしてください｡その際にはﾛｸﾞｲﾝ名/ﾊﾟｽﾜｰﾄﾞが必要となります｡<br />
②ｽﾏｰﾄﾌｫﾝ(Android)に変更する場合:ご利用いただけます｡｢しまじろうひろば×ﾄﾞｺﾓｺﾐｭﾆﾃｨ｣ｱﾌﾟﾘをﾀﾞｳﾝﾛｰﾄﾞし、ﾛｸﾞｲﾝしてください｡ただし､ﾌｨｰﾁｬｰﾌｫﾝで以前に投稿した思い出記録の写真が､やや小さく表示されます｡また､4~7月に獲得したﾌﾟﾚｾﾞﾝﾄのﾎﾟｽﾄｶｰﾄﾞ以外は引継ぎができませんので､ご了承ください｡<br />
...
②ﾎﾟｽﾄｶｰﾄﾞ<br />
｢思い出記録TOP｣→｢思い出記録｣ﾍﾟｰｼﾞ内｢獲得ﾌﾟﾚｾﾞﾝﾄ一覧｣の｢ﾎﾟｽﾄｶｰﾄﾞ｣→お好きなﾃﾝﾌﾟﾚｰﾄを選択→お好きな写真を4枚選択→｢印刷用URLを送る｣を選択し､ﾊﾟｿｺﾝにﾃﾞｰﾀを送信します｡→ﾊﾟｿｺﾝからｱｸｾｽし､印刷します｡<br />
</span></td>
</tr>
</table>
</div>
...
①携帯電話から｢http://dctry.jp/shimajiro/(しまじろうひろば×ﾄﾞｺﾓｺﾐｭﾆﾃｨTOP)｣にｱｸｾｽし､｢今すぐ登録(無料)｣を選択します｡<br />
②各項目(ﾛｸﾞｲﾝ名､ﾊﾟｽﾜｰﾄﾞ､ﾊﾟｽﾜｰﾄﾞ確認､子どものﾆｯｸﾈｰﾑ､子どもの性別､子どもの生年月､子どもの年齢など)を入力･確認すると､登録が完了します｡<br />
※ﾄﾞｺﾓｼｮｯﾌﾟ､ﾄﾞｺﾓ ｲﾝﾌｫﾒｰｼｮﾝｾﾝﾀｰ､ﾍﾞﾈｯｾお問い合わせ窓口ではお手続きできませんのでご注意ください｡
<br />
《ﾄﾞｺﾓｺﾐｭﾆﾃｨに登録済みの方》<br /> 
【ﾄﾞｺﾓの方】<br />
投稿したい思い出を選択→｢家族や友達と思い出を共有しよう!｣(ﾄﾞｺﾓｺﾐｭﾆﾃｨﾊﾞﾅｰ)を選択します｡<br />
①初回<br />
表示のあるｱﾄﾞﾚｽ(diary@docomo-community.ne.jp)を選択するとﾒｰﾙがたちあがります｡<br />
→ﾀｲﾄﾙ･本文を入力､送信→ﾄﾞｺﾓｺﾐｭﾆﾃｨに表示されます｡<br />
(ｱﾄﾞﾚｽは2回目以降も使用しますので､diary@docomo-community.ne.jpを携帯電話のｱﾄﾞﾚｽ帳に登録しておいてください｡)<br />
②2回目以降<br />
｢ﾀﾞｳﾝﾛｰﾄﾞ｣→｢ﾒｰﾙ作成｣→ﾒｰﾙがたちあがります｡<br />
...
<td bgcolor="#fff0dd"><span style="font-size:x-small;color:#333333">｢わが子をみんなに大自慢!!(他の会員に公開する)｣を選択すると､送信いただく内容が"育児なう"の他のﾕｰｻﾞの画面上に表示されます｡<br />
以下の事項および利用規約を必ずご確認ください｡<br />
･写真を公開する場合は､必ず事前に写真の被写体(被写体が未成年者の場合は保護者)の方全員のご了解を得てください｡<br />
･お名前などの個人情報は入力しないでください｡<br />
･投稿後､"育児なう"掲載まで約1週間程度かかります｡※運営による選定を行うため､掲載されない場合もあります｡<br />
･ｻｲﾄ掲載に必要な範囲内で､写真ｻｲｽﾞ､文字数などの調整を行う場合があります｡<br />
･公開または非公開の設定は､投稿後に変更できます｡<br />
･投稿は携帯電話のﾒｰﾙ送付機能を使いますが､ﾒｰﾙ送信過程でのﾄﾗﾌﾞﾙについては<br />当ｻｲﾄ運営者(株式会社ﾍﾞﾈｯｾｺｰﾎﾟﾚｰｼｮﾝおよび株式会社NTTﾄﾞｺﾓ)は責任を負いかねます｡<br />
</span></td>
</tr>
</table>
</div>
...
各ﾍﾟｰｼﾞ下部｢設定変更｣→｢ﾊﾟｽﾜｰﾄﾞを変更する｣→新しく設定するﾊﾟｽﾜｰﾄﾞを入力→｢確認｣→｢変更｣</span></td>
</tr>
</table>
</div>
