...
<div id="main">
  ...
  <dl id="contents">
    <dt>
        <a id="baby"><?php echo $this->Html->image("sp_img/txt_baby.png", array("alt" => "こどもちゃれんじ baby", "width" => "100%")); ?></a><br /><span class="baby">0～1歳向けコース</span>
    </dt>
    <dd>
...
<?php endif; ?>
    ...
    <dt>
    	<a id="jump"><?php echo $this->Html->image("sp_img/txt_jump.png", array("alt" => "こどもちゃれんじ じゃんぷ", " width" => "100%")); ?></a><br /><span class="jump">5～6歳向けコース</span>
    </dt>
    <dd>
