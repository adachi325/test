...
<a href="android-intro.html" data-transition="slide"><h1>Androidアプリ リリース！</h1><?php echo $this->Html->image("sp_img/kochare_appli.png", array("alt" => "", "width" => "80", "height" => "80", "align" => "middle")); ?><p><こどもちゃれんじ>
...
<div id="main">
  ...
  <dl id="contents">
   ...
   <dd>
    ...
    <dt>
    	<?php echo $this->Html->image("sp_img/txt_petit.png", array("alt" => "こどもちゃれんじ ぷち", "width" => "100%")); ?><br /><span class="petit">1～2歳向けコース</span>
    </dt>
    <dd>
