...
プロフィール登録が完了いたしました。次回からは自動ログインとなります。<br />
<div align="center" style="text-align:center;"><?php echo $this->Html->image("dot_line_orrange.gif", array()); ?></div>
まずはお子さんの思い出を記録してみよう!
ケータイに入っているお子さんのベストショットにコメントをつけてメール<?php $this->Ktai->emoji(0xE6D3); ?>送信してみてね!<br />
<div align="center" style="text-align:center;"><?php echo $this->Html->image("dot_line_orrange.gif", array()); ?></div>

<span style="color:#ff6600;">・</span><span style="color:#339933">最初のテーマ:ベストショット</span><br />
...
<span style="color:#cc0000;">※公開する「思い出記録」については、ベネッセにて選定を行います。</span><br />
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "10")); ?><br />
...
今は送信しないで<a href="<?php echo $this->Html->url('/');?>">トップページ</a>へ進む<br />
<?php echo $this->Html->image("spacer.gif", array("width" => "1", "height" => "10")); ?><br />
