...
<span style="color:#339900;font-size:medium"><a href="mailto:<?php echo Configure::read('Defaults.docomo_community'); ?>?subject=<?php echo rawurlencode(mb_convert_encoding($mailTitle, "utf8"));?>&body=<?php echo rawurlencode(mb_convert_encoding($mailBody, "utf8"));?>" style="color:#339900;"><span style="color:#339900;font-size:medium">思い出を記録に残す</span></a></span>
<?php else: ?>
<span style="color:#339900;font-size:medium"><?php $this->Ktai->mailto("思い出を記録に残す", Configure::read('Defaults.docomo_community'), $mailTitle,$mailBody); ?></span>
