...
<span style="color:#339933;">&nbsp;･</span><a href="<?php echo$html->link($html->image('btn_dcm.gif', array('width' => '100%')), '/diaries/post/'.$diary['Diary']['id'], array('escape' => false)); ?>" style="color:#339900;"><span style="color:#339900;">この思い出記録を家族や友達と共有する</span></a><br />
