...
?>
      <a href="<?php echo $this->Html->url("/hanamarus/add_hanamaru?id={$diary['Diary']['id']}&user_id={$user['hash']}&returnPath={$encoded_url}"); ?>"><?php echo $this->Html->image("icn_hanamaru_btn.gif", array("alt" => "はなまる", "width" => "100%", "style" => "margin:4px 2px 4px 0;")); ?></a><span style="font-size:x-small; color:#FF0000;"><?php echo $article['Diary']['hanamaru_count']; ?>ｺ</span>
<?php endif; ?>
