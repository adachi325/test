...
<div align="center" style="text-align:center"><a href="#"><?php echo $this->Html->image("docomo_commu_banner.gif", array('url' => '/diaries/post/'.$diary['Diary']['id'])); ?></a><br />
<span style="color:#666666; font-size:x-small">※ﾄﾞｺﾓｺﾐｭﾆﾃｨ会員登録が必要です</span></div>
