...
<?php if ($alreadyAddHanamaru) : ?>
  <span style="font-size:x-small; color:#FF0000;"><?php echo $this->Html->image("icn_hanamaru_btn.gif", array("alt" => "はなまる", "width" => "60", "height" => "21", "style" => "margin:0px 2px 0px 0;")); ?><?php echo $this->Html->image("icn_hanamaru.gif", array("alt" => "はなまる", "border" => "0", "width" => "20", "height" => "18", "style" => "margin:0 4px 0 0;")); ?><?php echo $diary['Diary']['hanamaru_count']; ?>ｺ</span>
<?php else : ?>
<?php
...
?>
      <a href="<?php echo $this->Html->url("/hanamarus/add_hanamaru?id={$diary['Diary']['id']}&user_id={$user['User']['hash']}&returnPath={$encoded_url}"); ?>"><?php echo $this->Html->image("icn_hanamaru_btn.gif", array("alt" => "はなまる", "width" => "60", "height" => "21", "style" => "margin:0px 2px 0px 0;")); ?></a><span style="font-size:x-small; color:#FF0000;"><?php echo $diary['Diary']['hanamaru_count']; ?>ｺ</span>
<?php endif; ?>
