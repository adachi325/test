...
<tr>
<td><span style="font-size:x-small; color:#333333;">▼ｶﾃｺﾞﾘ別に見る<br />
<a href="<?php echo $url_diaries; ?>" style="color:#339900;"><span style="color:#339900;">お友達の様子</span></a>｜<a href="<?php echo $url_news; ?>" style="color:#0099FF;"><span style="color:#0099FF;">ﾆｭｰｽ</span></a>｜<a href="<?php echo $url_test; ?>" style="color:#9933CC;"><span style="color:#9933CC;">心理ﾃｽﾄ</span></a><br />
<a href="<?php echo $url_notify; ?>" style="color:#ff9900;"><span style="color:#ff9900;">お知らせ</span></a>｜<a href="<?php echo $url_all; ?>" style="color:#ff9900;"><span style="color:#ff9900;">全て</span></a>
</span></td>
</tr>
</table>
