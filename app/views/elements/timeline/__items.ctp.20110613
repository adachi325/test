...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="<?php echo $color; ?>">
<tr>
<td width="25%" rowspan="2" align="left" valign="top" style=" font-size:x-small; color:#ff9900;"><?php echo $this->Html->image("icn_bule_news.gif", array("alt" => "ニュース", "width" => "100%", "style" => "margin:1px 3px 0 0;")); ?><br /><?php echo $this->Html->image($article['Article']['photo'], array("alt" => "ニュース画像", "width" => "100%", "style" => "margin:5px 2px 5px 0;")); ?></td>
...
<?php echo $this->Html->image($article['Article']['photo'], array("alt" => "お知らせ画像", "width" => "100%", "style" => "margin:5px 2px 5px 0;")); ?></td>
...
<?php echo $this->Html->image($article['Article']['photo'], array("alt" => "心理テスト画像", "width" => "100%", "style" => "margin:5px 2px 5px 0;")); ?></td>
