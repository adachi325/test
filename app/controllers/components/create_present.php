...
class CreatePresentComponent extends Object {
	...
	$this->log("1:".$template,LOG_DEBUG);
        ...
        $assign = array(
            // 差し込み画像
            'pic_01' => WWW_ROOT.'img/'.sprintf(Configure::read('Diary.image_path_postcard_sp'), $args['child_id'], $args['diary_id'][0]),
            'pic_02' => WWW_ROOT.'img/'.sprintf(Configure::read('Diary.image_path_postcard_sp'), $args['child_id'], $args['diary_id'][1]),
            'pic_03' => WWW_ROOT.'img/'.sprintf(Configure::read('Diary.image_path_postcard_sp'), $args['child_id'], $args['diary_id'][2]),
        );
