...
$config['Present'] = array(
	...
	'membersonly' => array(
        ...
        'path' => array(
                ...
                'wallpaper' => 'present/template/wallpaper/%s.png', //スマホ用待受け画面
                'wallpaper_output' => 'present/output/postcard/%s.jpg', //スマホ用待受け画面
                'wallpaper_output_thumb' => 'present/output/postcard/%s_thumb.jpg',  //スマホ用待受け画面
...
$config['Diary'] = array(
	...
	'image_size_thumb_wallpaper' => 220,	//SmartPhone:このサイズ内に元の比率で収まるようにリサイズ
	'image_size_rect' => 75,		//正方形
	'image_size_rect_wallpaper' => 432,	//SmartPhone:正方形
	'image_size_postcard' => 210,           //正方形
	'image_size_wallpaper' => 432,  	//SmartPhone:正方形
	'image_path_original' => "photo/%s/%s_original.jpg",	//一時保存用
	'image_path_thumb' => "photo/%s/%s_thumb.jpg",		//比率保持サムネイル
	'image_path_thumb_wallpaper' => "photo/%s/%s_wallpaper_thumb.jpg",	//スマホ用比率保持サムネイル
	'image_path_rect' => "photo/%s/%s_rect.jpg",		//正方形サムネイル
	'image_path_rect_wallpaper' => "photo/%s/%s_wallpaper_rect.jpg",		//スマホ用正方形サムネイル
	'image_path_postcard' => "photo/%s/%s_postcard.jpg",	//ポストカード用
	'image_path_wallpaper' => "photo/%s/%s_wallpaper.jpg",	//待受け静止画用
	'title_len_max' => 20,
	'body_len_max' => 5000,
