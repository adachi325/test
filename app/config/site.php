...
$config['Present'] = array(
	...
	'membersonly' => array(
        ...
        'path' => array(
                ...
                'wallpaper' => 'present/template/postcard/%s.png', //スマホ用待受け画面
...
$config['Diary'] = array(
	...
	'image_size_thumb_sp' => 220,		//SmartPhone:このサイズ内に元の比率で収まるようにリサイズ
	'image_size_rect' => 75,		//正方形
	'image_size_rect_sp' => 75,		//SmartPhone:正方形
	'image_size_postcard' => 210,           //正方形
	'image_size_wallpaper' => 210,  	//SmartPhone:正方形
	'image_path_original' => "photo/%s/%s_original.jpg",	//一時保存用
	'image_path_thumb' => "photo/%s/%s_thumb.jpg",		//比率保持サムネイル
	'image_path_thumb_sp' => "photo/%s/%s_thumb.jpg",	//スマホ用比率保持サムネイル
	'image_path_rect' => "photo/%s/%s_rect.jpg",		//正方形サムネイル
	'image_path_rect_sp' => "photo/%s/%s_rect.jpg",		//スマホ用正方形サムネイル
	'image_path_postcard' => "photo/%s/%s_postcard.jpg",	//ポストカード用
	'image_path_wallpaper' => "photo/%s/%s_postcard.jpg",	//ポストカード用
	'title_len_max' => 20,
	'body_len_max' => 5000,
